...
console.log(chalk.bold.rgb(204, 204, 204)(`<<<=========>>>  ${chalk.redBright.bold('Wellcome To \'Code With Hamza\' - CLI Simple Calculator')}  <<<=========>>>`));
console.log(chalk.bold.rgb(204, 204, 204)(`\t\t <<<===============================================>>>\n`));
// console.log(chalk.bold.italic.bgYellow("\n\tWellcome To \'Code With Hamza\' - CLI Simple Calculator\n"));
